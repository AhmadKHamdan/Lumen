...
\begin{table}[H]
\centering
\caption{Destination rooms and their indicator objects (all COCO classes). Arrival
...
\begin{tikzpicture}[node distance=5mm]
  ...
  \draw[arr] (arb) -- (rel);
\end{tikzpicture}}
\caption{The door perception funnel. Each layer was added in response to a specific
...
\end{tikzpicture}}
\caption{The navigation controller's internal state machine (nested inside the
