...
vision systems tend to either narrate the scene continuously, overwhelming the user
with a constant auditory stream, or answer isolated queries, forcing the user to know
what to ask for in a space they cannot see. This work presents \textbf{Lumen}, a
...
destination room, and Lumen guides them door-by-door --- a compass-anchored $360^\circ$
room scan, semantic arrival detection from room-indicator objects, a three-layer door
perception funnel built around a custom-trained door detector (mAP@50 $= 0.946$), a
pinhole distance model that speaks in steps, doorway-transit detection, and an
...
journeys. Live trials in real apartments drove the perception design
failure-by-failure, from curtain and blank-wall rejection to compass-confirmed scan
completion. Lumen demonstrates that structured, task-scoped assistance --- perception
